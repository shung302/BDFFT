...
set weight = "$ws-$we"
#if ( -f try.simple_ray_se"$weight"_"$damp".$F.$mdl ) continue
...
$we
!
mv try.xyz try.simple_ray_se"$weight"_"$damp".$F.$mdl
mv try.sum sum.simple_ray_se"$weight"_"$damp".$F.$mdl
mv results results.simple_ray_se"$weight"_"$damp".$F.$mdl
mv station_correction stacor.simple_ray_se"$weight"_"$damp".$F.$mdl
mv event_correction evtcor.simple_ray_se"$weight"_"$damp".$F.$mdl
end #foreach damp
end #foreach ws
