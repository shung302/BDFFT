...
#if ( -f try.quell_kern_se"$weight"_"$damp"-"$sigma".$F.$mdl ) continue
...
$sigmah $sigmaz
!
mv try.xyz try.quell_kern_se"$weight"_"$damp"-"$sigma".$F.$mdl
mv try.sum sum.quell_kern_se"$weight"_"$damp"-"$sigma".$F.$mdl
mv results results.quell_kern_se"$weight"_"$damp"-"$sigma".$F.$mdl
mv station_correction stacor.quell_kern_se"$weight"_"$damp"-"$sigma".$F.$mdl
mv event_correction evtcor.quell_kern_se"$weight"_"$damp"-"$sigma".$F.$mdl
end #foreach damp
end #foreach ws
end #foreach sigmaz
