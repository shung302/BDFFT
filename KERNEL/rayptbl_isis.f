...
c       fnm='/home/dna/software/tomoregionalBD/src/kernel_new/iasp/rayp.'//pha(iraytype)(1:lp)//'.out'
        fnm='/data/isis/dna/software/tomoregionalBD/src/kernel_new/iasp/rayp.'//pha(iraytype)(1:lp)//'.out'
c        write(6,*)fnm
