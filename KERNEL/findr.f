...
c         if (r.eq.rcmb) ir=3
c PREM or 11 homogeneous layered models
      elseif (ivin.eq.1.or.ivin.eq.-3) then
...
c        write(6,*)ivin,r,rdis(1),rdis(11)
         if (r.le.ardis(1)) then
         ir=1
         return
         endif

         if (r.gt.ardis(11)) then
         ir=12
         return
         endif
         do i=2,11
         if (r.gt.ardis(i-1).and.r.le.ardis(i)) then
            ir=i
            return
         endif
         enddo
